...
- `git clone https://github.com/UniversalPropositions/UP_Russian-GSD.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Russian-GSD>/ --input_up=<up_path_to_UP_Russian-GSD>/ --output=<path_to_UD+UP_Russian-GSD>/`
